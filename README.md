...
![HSV Fixed Value Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheels/color-wheel-hsv-fixed-value-three.png")
...
![HSL Fixed Lightness Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-lightness-three.png")
...
![HSV Fixed Saturation Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsv-fixed-saturation-three.png")
...
![HSL Fixed Saturation Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-three.png")
...
![HSL Fixed Saturation Smooth Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-smooth.png")
...
![HSL Fixed Saturation Smooth Reversed Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-smooth-reversed-colors.png")
...
![HSL Fixed Saturation Angular Bucketing Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-angular.png")
...
![HSL Fixed Saturation Radial Bucketing Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-radial.png")
...
![HSV Fixed Saturation Expand Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsv-fixed-saturation-expand.png")
...
![HSL Fixed Saturation Expand Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsl-fixed-saturation-expand.png")
...
![HSV Fixed Saturation Coarse Color Wheel]("https://github.com/jamesthurley/color-wheel-renderer/raw/master/integration-tests/input-data/color-wheel-hsv-fixed-saturation-coarse.png")
